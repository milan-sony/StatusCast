            ...
            <div className="w-full h-screen sm:overflow-hidden">
                <div className='pt-[100px] pl-10 pr-10'>
                    <div className='flex flex-col justify-center items-center sm:flex-row sm:justify-between text-center'>
                        <div>
                            <h1 className='text-xl sm:text-4xl font-bold font-[poppins] capitalize'>Hi {user?.firstName} | {user?.userName} <span className='badge badge-soft badge-success badge-xs'>Active</span></h1>
                        </div>
                        <div className='mt-3'>
                            ...
                            <div className='grid grid-cols-1 xl:grid-cols-3 gap-4'>
                                {
                                    allUserStatus.length === 0 ? (
                                        <div className='flex flex-col justify-center items-center text-center p-4 bg-base-100 rounded-box sm:w-md sm:flex-row sm:justify-between sm:text-left sm:items-center'>
                                            <div className='flex justify-center'>
                                                <p className='font-roboto text-sm'>No one has set any status!</p>
                                            </div>
                                        </div>
                                    ) : (
